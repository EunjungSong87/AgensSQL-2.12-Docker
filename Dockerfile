...
ADD P-AgensSQL-AS_2.12_D_AS-72.zip /usr/src/
...
# https://www.postgresql.org/docs/10/static/release-10.html#id-1.11.6.9.5.13
        ...
        ; \
	\
	unzip /usr/src/P-AgensSQL-AS_2.12_D_AS-72.zip -d /usr/src/; \
	mv /usr/src/P-AgensSQL-AS_2.12_D_AS-72 /usr/src/postgresql; \
	rm /usr/src/P-AgensSQL-AS_2.12_D_AS-72.zip; \
	\
...
#		--with-pam \
	...
	; \
	\
	/bin/bash -c 'echo "/usr/local/lib" > /etc/ld.so.conf.d/agenssql.conf'; \
    ldconfig; \
    \
	postgres --version
